...
np.save('analysis/selected_var_grad.npy', all_var_grads)
np.save('analysis/selected_smooth_grad_square.npy', all_smooth_square_grads)

all_var_grads = np.load('analysis/selected_var_grad.npy')
